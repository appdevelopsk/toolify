...
export const LOCALE_DEFS = [
  ...
  { code: "zh-CN", name: "Chinese (Simplified)", native: "简体中文", dir: "ltr", active: false },
  { code: "zh-TW", name: "Chinese (Traditional)", native: "繁體中文", dir: "ltr", active: false },
  { code: "ko", name: "Korean", native: "한국어", dir: "ltr", active: false },
  { code: "es", name: "Spanish", native: "Español", dir: "ltr", active: false },
